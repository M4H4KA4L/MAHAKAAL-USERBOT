...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "MahakaalBot")
       ...
       # PLUGIN_CHANNEL = int(os.environ.get("PLUGIN_CHANNEL", None))
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/M4H4KA4L/MAHAKAALBOT"
        )
        ...
        EXTRA_MAHAKAALBOT = os.environ.get("EXTRA_MAAHAKAALBOT", -1001221881562)
        PM_DATA = os.environ.get("PM_DATA", "ENABLE")
        MAHAKAALBOT_LOGGER = int(os.environ.get("MAHAKAALBOT_LOGGER", None))
