...
from mahakaalbot.Config import Config
from mahakaalbot.plugins.sql_helper.fban_sql import (
    add_channel,
    get_all_channels,
    in_channels,
    rm_channel,
...
@mahakaalbot.on(admin_cmd(pattern="fban ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="fban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@mahakaalbot.on(admin_cmd(pattern="unfban ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="unfban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mssg = await eor(event, "`...`")
...
@mahakaalbot.on(admin_cmd(pattern=r"fadd ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern=r"fadd ?(.*)", allow_sudo=True))
...
@mahakaalbot.on(admin_cmd(pattern=r"fremove ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern=r"fremove ?(.*)", allow_sudo=True))
...
@mahakaalbot.on(admin_cmd(pattern="fgroups"))
@mahakaalbot.on(sudo_cmd(pattern="fgroups", allow_sudo=True))
...
@mahakaalbot.on(admin_cmd(pattern="fsearch ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="fsearch ?(.*)", allow_sudo=True))
...
@mahakaalbot.on(admin_cmd(pattern="newfed ?(.*)", outgoing=True))
@mahakaalbot.on(sudo_cmd(pattern="newfed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    async with borg.conversation(chat) as conv:
        try:
            ...
            await event.client.send_message(chat, f"/newfed {mahakaal_input}")
...
@mahakaalbot.on(admin_cmd(pattern="renamefed ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="renamefed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    mahakaal_input = event.pattern_match.group(1)
    ...
    async with event.client.conversation(chat) as conv:
          try:     
              ...
              await event.client.send_message(chat, f"/renamefed {mahakaal_input}")
              response = await response 
          except YouBlockedUserError: 
...
@mahakaalbot.on(admin_cmd(pattern="fstat ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="fstat ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mahakaal = await event.edit("`Collecting fstat....`")
    thumb = mahakaal_logo
    if event.reply_to_msg_id:
        previous_message = await event.get_reply_message()
        ...
        async with borg.conversation(bot) as conv:
            try:
                ...
                if "Looks like" in massive.text:
                    ...
                    massive = await conv.get_response()
                    await mahakaalbot.send_file(
                        event.chat_id,
                        massive,
                        thumb=thumb,
                        caption=f"List of feds {user} has been banned in.\n\n**⚡ [Collected using MahakaalBot](t.me/Official_MahakaalBot_Support) ⚡**",
                    )
                else:
                    await borg.send_message(event.chat_id, massive.text)
                await event.delete()
            except YouBlockedUserError:
                await mahakaal.edit("`Please Unblock` @MissRose_Bot")


@mahakaalbot.on(admin_cmd(pattern="fedinfo ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="fedinfo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mahakaal = await eor(event, "`Fetching fed info.... please wait`")
    lavde = event.pattern_match.group(1)
    async with borg.conversation(bot) as conv:
        try:
            await conv.send_message("/start")
            ...
            massive = await conv.get_response()
            await mahakaal.edit(massive.text + "\n\n**LEGENDARY_AF_MAHAKAALBOT**")
        except YouBlockedUserError:
            await mahakaal.edit("`Please Unblock` @MissRose_Bot")
