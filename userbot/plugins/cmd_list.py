...
async def install(event):
    ...
    _o = o.split("\n")
    o = "\n".join(_o)
    OUTPUT = f"List of Plugins in MahakaalBot :- \n\n{o}\n\n<><><><><><><><><><><><><><><><><><><><><><><><>\nHELP:- If you want to know the commands for a plugin, do :- \n.plinfo <plugin name> without the < > brackets. \nJoin https://t.me/Official_MahakaalBot_Chat for help."
    if len(OUTPUT) > 69:
        with io.BytesIO(str.encode(OUTPUT)) as out_file:
            out_file.name = "cmd_list.text"
            mahakaal_file = await bot.send_file(
                event.chat_id,
                out_file,
                force_document=True,
                allow_cache=False,
            ...
            await edit_or_reply(mahakaal_file, f"Output Too Large. This is the file for the list of plugins in mahakaalbot.\n\n**BY :-** {DEFAULTUSER}")
            await event.delete()