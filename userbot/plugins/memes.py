...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(e, "Click [here](https://github.com/M4H4KA4L/MAHAKAALBOT) to open this 🔥**Lit AF!!**🔥 __MAHAKAALBOT__ Repo.. Join channel :- @Official_MahakaalBot_Support")
...
async def smrk(smk):
    ...
    if message == "dele":
        await edit_or_reply(smk, message + "te the mahakaal" + "ツ")
