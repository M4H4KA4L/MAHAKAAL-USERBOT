...
async def gbun(event):
    ...
    no_reason = "__Reason: Pagal Hai"
    await event.edit("** Chala Jaa Bhutiye❗️⚜️☠️**")
    asyncio.sleep(3.5)
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1212368262 or 991338956:
            await reply_message.reply(
                "`Wait a second, This is my master!`\n**How dare you threaten to ban my master nigger!**\n\n__Your account has been hacked! Pay 99$ to my master__ [Mahakaal](https://t.me/Belongs_to_Lord_Shiva_nd_Haryana) __to release your account__😏"
            )
        else:
            jnl = (
                "`Warning!! `"
