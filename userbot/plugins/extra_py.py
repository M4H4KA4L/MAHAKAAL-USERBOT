...
from mahakaalbot.utils import admin_cmd, load_module
from var import Var
...
CmdHelp("extra_py").add_command(
  'extdl', None, 'Installs all plugins from the channal which id is in MAHAKAALBOT_LOGGER variable'
).add_command(
