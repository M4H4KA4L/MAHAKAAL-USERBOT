...
@bot.on(admin_cmd(pattern=r"mahakaalo$"))
@bot.on(sudo_cmd(pattern="mahakaalo$", allow_sudo=True))
async def bluedevilmahakaalo(mahakaalo):
    if mahakaalo.fwd_from:
        return
    await edit_or_reply(mahakaalo, K)
