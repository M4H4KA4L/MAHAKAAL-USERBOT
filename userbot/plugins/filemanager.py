...
async def _(event):
    ...
    process = await asyncio.create_subprocess_smahakaal(
        cmd, stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
    )
    OUTPUT = f"**Files in [MahakaalBot](t.me/MahakaalBot_official) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your mahakaalbot server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of mahakaalbot repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your mahakaalbot server'
).add_command(
