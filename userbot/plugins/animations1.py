...
async def _(event):
    ...
    await edit_or_reply(event, "mahakaalo")
    animation_chars = [
        "Indian Flag",
...
async def _(event):
    ...
    animation_chars = [
        ...
        "`Call Connected.`",
        "`Secretary: mahakaalo This is Raj Bhawan. Who is this?`",
        f"`Me: mahakaalo this is` `{DEFAULUSER}` .Please connect me to Prime Minister",
        "`User Authorised.`",
        "`Calling`  `At +9189*#*#*#56`",
        "`Private  Call Connected...`",
        "`Me: mahakaalo Sir, How are you!!`",
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1212368262:
            await event.edit(
                "This is My Master\n**How dare you trying to tell me to kill master nigger!**\n\n__Your account is on hold! Pay 99$ to my master__ [Mahakaal](https://t.me/Belongs_to_Lord_Shiva_nd_Haryana) __to release your account__😏"
            )
        else:
