...
@mahakaalbot.on(admin_cmd(pattern="sin ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@mahakaalbot.on(admin_cmd(pattern="cos ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@mahakaalbot.on(admin_cmd(pattern="tan ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@mahakaalbot.on(admin_cmd(pattern="cosec ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@mahakaalbot.on(admin_cmd(pattern="sec ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@mahakaalbot.on(admin_cmd(pattern="cot ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@mahakaalbot.on(admin_cmd(pattern="square ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@mahakaalbot.on(admin_cmd(pattern="cube ?(.*)"))
@mahakaalbot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
