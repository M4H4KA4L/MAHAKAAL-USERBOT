...
async def hmm(mahakaal):
    if mahakaal.fwd_from:
        return
    reactcat = nekos.textcat()
    await edit_or_reply(mahakaal, reactcat)
...
async def hmm(mahakaal):
    if mahakaal.fwd_from:
        return
    whymahakaal = nekos.why()
    await edit_or_reply(mahakaal, whymahakaal)
...
async def hmm(mahakaal):
    if mahakaal.fwd_from:
        return
    factmahakaal = nekos.fact()
    await edit_or_reply(mahakaal, factmahakaal)
