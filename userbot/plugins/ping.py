...
Belongs_to_Lord_Shiva_nd_Haryana = borg.uid
...
async def _(event):
    ...
    ms = (end - start).microseconds / 1000
    if MAHAKAAL_IMG:
        mahakaal_caption = f"__**〘 ♕ ᑭσɳց! ♕ 〙__**\n\n   ⚘ {ms}\n   ⚘ __**𝙼𝚢**__ __**𝙼𝚊𝚜𝚝𝚎𝚛**__⟿[{DEFAULTUSER}](tg://user?id={Belongs_to_Lord_Shiva_nd_Haryana})"
        await event.client.send_file(
            event.chat_id, MAHAKAAL_IMG, caption=mahakaal_caption
        )
        await event.delete()
