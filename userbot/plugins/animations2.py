...
async def _(event):
    ...
    animation_chars = [
        ...
        "__INFO:MahakaalBot:Logged in as 557667062__",
        "__INFO:MahakaalBot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
async def ammastar(mahakaalstar):
  
    if mahakaalstar.fwd_from:
    ...
    await edit_or_reply(mahakaalstar, "I am A Star")
    ...
    for i in animation_ttl:
        ...
        await mahakaalstar.edit(animation_chars[i % 11])
