...
from mahakaalbot.utils import admin_cmd, sudo_cmd, edit_or_reply as eor
...
@mahakaalbot.on(admin_cmd(pattern="hvd$"))
@mahakaalbot.on(sudo_cmd(pattern="hvd$", allow_sudo=True))
...
@mahakaalbot.on(admin_cmd(pattern="vday$"))
@mahakaalbot.on(sudo_cmd(pattern="vday$", allow_sudo=True))
async def gif(event):
    if event.fwd_from:
        return
